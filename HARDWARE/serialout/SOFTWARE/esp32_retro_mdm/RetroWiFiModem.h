...
//#ifdef ESP32_DEV
//#define CTS 19           // (GPIO15) output
#define CTS 35
//#define RTS 20            // (GPIO13) input
#define RTS 34
//#define RI  18            // (GPIO12) output
#define RI  25
//#define DSR 24            // (GPIO04) output
#define DSR 26            // (GPIO04) output
//#define DCD 34           // (GPIO05) output
#define DCD 27           // (GPIO05) output
//#define TXEN 17           // (GPIO14) output
#define TXEN 14           // (GPIO14) output
//#endif
//#define SDA 2
#define SDA 33
//#define SCL 3
